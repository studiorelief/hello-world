...
export default function OffreCalculator() {
  ...
  return (
    <div className="min-h-screen bg-[#ffefe0] py-8">
      <div className="max-w-7xl mx-auto px-4">
        {/* Hero Section */}
        <div className="text-center mb-12">
          <div className="inline-block bg-transparent border border-[#d8a5dc] rounded-full px-4 py-2 mb-6">
            <span className="text-[#2e040a] font-medium">OFFRE</span>
          </div>
          <h1 className="text-5xl font-bold text-[#2e040a] mb-4">
            Configurez votre projet
          </h1>
          <p className="text-xl text-[#6d4b4a] max-w-2xl mx-auto">
